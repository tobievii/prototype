...
function Decode(bytes, port) {
    var weekNumberTimeOfWeek = (bytes[16] << 24) | (bytes[15] << 16) | (bytes[14] << 8) | (bytes[13] << 0);
    ...
    var decoded = {
        ...
        GPSTimestamp: GPSDate.toString(),
        GPSHorizontalAccuracy: number,
        GPSVerticalAccuracy: number,
        AccOperatingMinutes1: number,
        AccOperatingMinutes2: number,
        AccNumberShocks: any,
        Temperature: number,
        ...
        BTNum: any,
        SoftwareVersion: any,
        BootblockVersion: any,
        HardwareVersion: any,
        RegionCode: any,
        ConfigurationMessageId: any,
    ...
    if (port === 1) {
        ...
        if (decoded.MessageType === 0x00) {
            ...
            GPSDate.setSeconds(decoded.GPSTimeOfWeek);
