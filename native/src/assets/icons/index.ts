...
export const DeviceList = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
...
export const Documentation = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
...
export const Favorites = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require("./eva/heart.png")
  };
...
export const Support = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require("./eva/bulb.png")
  };
