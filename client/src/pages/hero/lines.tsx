...
export class Lines extends React.Component<MyProps, MyState> {
    ...
    render() {
        ...
        var rx = (this.props.rx) ? 0.5 : 1
        var tx = (this.props.tx) ? 0.5 : 1
        var nrx = (!this.props.rx) ? 0.5 : 1
        var ntx = (!this.props.tx) ? 0.5 : 1
        ...
        var transform1: any = "translate(0 " + (Math.sin((this.frame * 5) / 25) * 2) + ")"
        var transform2: any = "translate(0 " + (Math.sin((this.frame * 5 + 30) / 25) * 2) + ")"
        var transform3: any = "translate(0 " + (Math.sin((this.frame * 5 + 60) / 25) * 2) + ")"
        var transform4: any = "translate(0 " + (Math.sin((this.frame * 5 + 100) / 25) * 2) + ")"
        var transform5: any = "translate(0 " + (Math.sin((this.frame * 5 + 130) / 25) * 2) + ")"
        var transform6: any = "translate(0 " + (Math.sin((this.frame * 5 + 160) / 25) * 2) + ")"
        ...
        var colServer1 = "hsla(" + ((Math.sin((this.frame * 5) / 25) * 15) + 20) + ", 100%, 50%, 1)"
        var colServer2 = "hsla(" + ((Math.sin((this.frame * 5 + 30) / 25) * 15) + 40) + ", 100%, 50%, 1)"
        var colServer3 = "hsla(" + ((Math.sin((this.frame * 5 + 60) / 25) * 15) + 70) + ", 100%, 50%, 1)"
        var colServer4 = "hsla(" + ((Math.sin((this.frame * 5 + 100) / 25) * 15) + 140) + ", 100%, 50%, 1)"
        var colServer5 = "hsla(" + ((Math.sin((this.frame * 5 + 130) / 25) * 15) + 180) + ", 100%, 50%, 1)"
        var colServer6 = "hsla(" + ((Math.sin((this.frame * 5 + 160) / 25) * 15) + 200) + ", 100%, 50%, 1)"
